...
const mockGroup = {
  id: 10,
  content_hash: 'abc123deadbeef001234',
...
describe('DuplicateResolver', () => {
  it('shows loading initially', () => {
    ...
    renderWithProviders(<DuplicateResolver />, {
      initialPath: '/devices/1/duplicates',
      routePath: '/devices/:id/duplicates',
    })
  ...
  it('shows "No unresolved" when no groups and stats has 0 total', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByText(/No unresolved duplicate groups/i)).toBeInTheDocument()
    )
  })
